...
import {
  ...
  Divider, useTheme, Badge, IconButton
} from '@mui/material';
import {
  Notifications, Timeline, Verified, ExitToApp, Business,
  LocalShipping, TrendingUp, Security, Add, Settings,
  QrCodeScanner, Search, Person, Logout, History as HistoryIcon
